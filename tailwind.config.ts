	...
	theme: {
		...
		extend: {
			fontFamily: {
				...
				heading: ['DM Sans', 'Poppins', 'system-ui', 'sans-serif'],
			...
			colors: {
				...
				canada: 'hsl(var(--canada))',
				germany: 'hsl(var(--germany))',
				australia: 'hsl(var(--australia))',
				portugal: 'hsl(var(--portugal))',
				usa: 'hsl(var(--usa))'
			},
			borderRadius: {
				lg: 'var(--radius-lg)',
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(215 85% 55% / 0.15)' },
					'50%': { boxShadow: '0 0 40px hsl(215 85% 55% / 0.25)' }
				},
				'pulse': {
					'0%, 100%': { opacity: '1' },
					'50%': { opacity: '0.7' }
